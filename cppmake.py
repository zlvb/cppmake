...
TEMPL1 = '''# Makefile: auto generated by cppmake
...
def export_Makefile(dirname):
    fd = open(dirname + "/Makefile", "wb+")
    if out[-1][-2:] == '.a':
        result = TEMPL1 + TEMPL22 + TEMPL3
    else:
        result = TEMPL1 + TEMPL21 + TEMPL3
    for tr in templ_table:
        if tr[3] == 0:
